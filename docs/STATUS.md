...
| API-only GTM orchestrator | Contract-test baseline implemented; live provider access blocked | Direct Google, LinkedIn, Facebook, Instagram, Threads and Cloudinary adapters; 16 local tests passed on 2026-08-31; no live OAuth permission or publication canary yet |
